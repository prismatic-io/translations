...
export interface ConfigWizardPhrases {
  ...
  /** English: "Used in ${usageCount} locations" */
  "configWizard.configPage.connection.field.usageLocations.label": ComplexPhrase<{
    usageCount: number;
  }>;
...
export const configWizardPhrases: ConfigWizardPhrases = {
  ...
  "configWizard.configPage.connection.field.usageLocations.label": {
    _: "Used in %{usageCount} locations",
    usageCount: 0,
  },
